...
import 'add_delivery_agent_model.dart';
export 'add_delivery_agent_model.dart';

class AddDeliveryAgentWidget extends StatefulWidget {
  const AddDeliveryAgentWidget({super.key});

  @override
  State<AddDeliveryAgentWidget> createState() => _AddDeliveryAgentWidgetState();
}

class _AddDeliveryAgentWidgetState extends State<AddDeliveryAgentWidget> {
  late AddDeliveryAgentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddDeliveryAgentModel());
                                    ...
                                    onPressed: () async {
                                      ...
                                      _model.apiResultr6m =
                                          await FirebaseFunctionGroup
                                              ...
                                              .call(
                                        cashBalance: 0.0,
                                        licenseImage: _model.uploadedFileUrl2,
                                        idProofImage: _model.uploadedFileUrl1,
                                        licenseNumber:
                                            _model.licenseNumberController.text,
                                        aadharNumber:
                                            _model.aadharNumberController.text,
                                      ...
                                      if ((_model.apiResultr6m?.succeeded ??
                                          true)) {
                                        setState(() {
                                          _model.aadharNumberController
                                              ?.clear();
