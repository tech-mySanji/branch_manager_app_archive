...
class _AddCategoryPageWidgetState extends State<AddCategoryPageWidget> {
  ...
  void initState() {
    ...
    _model.nameOfCategoryController ??= TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CategoriesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CategoriesRecord> addCategoryPageCategoriesRecordList =
            snapshot.data!;
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: SwitchListTile(
                                        value: _model.showIfValue ??= false,
                                        onChanged: (newValue) async {
                                          setState(() =>
                                              _model.showIfValue = newValue!);
                                        },
                                        title: Text(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Visibility(
                                          visible: _model.showIfValue == false,
                                          child: Padding(
                                            padding:
                                            ...
                                            child: FlutterFlowDropDown<String>(
                                              ...
                                              options: List<String>.from(
                                                  addCategoryPageCategoriesRecordList
                                                      .map((e) => e.categoryId)
                                                      .toList()),
                                              optionLabels:
                                                  addCategoryPageCategoriesRecordList
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          setState(() {
                                            ...
                                            _model.nameInSecondaryLangController
                                                ?.clear();
                                            _model.indexController?.clear();
                                          });
                                          setState(() {
                                            _model.parentCategoryValueController
                                                ?.reset();
                                          });
                                          ScaffoldMessenger.of(context)
                                              .showSnackBar(
