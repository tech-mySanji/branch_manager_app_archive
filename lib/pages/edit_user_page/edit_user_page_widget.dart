...
class _EditUserPageWidgetState extends State<EditUserPageWidget> {
  ...
  void initState() {
    ...
    _model.addressController ??=
        TextEditingController(text: widget.userDoc?.address);
    _model.addressFocusNode ??= FocusNode();

    _model.pincodeController ??=
        TextEditingController(text: widget.userDoc?.pincode?.toString());
    _model.pincodeFocusNode ??= FocusNode();

    _model.referralNameController ??=
        TextEditingController(text: widget.userDoc?.refName);
    _model.referralNameFocusNode ??= FocusNode();
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller: _model.referralNameController,
                                      focusNode: _model.referralNameFocusNode,
                                      onChanged: (_) => EasyDebounce.debounce(
                                        '_model.referralNameController',
                                        Duration(milliseconds: 2000),
                                        () => setState(() {}),
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Referral Name (optional)',
                                        enabledBorder: OutlineInputBorder(
                                          borderSide: BorderSide(
                                            color: Color(0xFF5C5C5C),
                                            width: 1.0,
                                      ...
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                      validator: _model
                                          .referralNameControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await widget.userDoc!.reference
                                      ...
                                      displayName: widget.userDoc?.displayName,
                                      phoneNumber:
                                      ...
                                      refName:
                                          _model.referralNameController.text,
                                    ));
