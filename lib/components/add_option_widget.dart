                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        if (_model.productNameController.text != '') {
                            ...
                            builder: (context) {
                              return Padding(
                                ...
                                child: ProductSearchListWidget(
                                  searchKey: _model.productNameController.text,
                                ),
                              );
                            },
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 0.0, 0.0),
                    child: TextFormField(
                      controller: _model.optionNameController,
                      focusNode: _model.optionNameFocusNode,
                      autofocus: true,
                      obscureText: false,
                      decoration: InputDecoration(
                      ...
                      validator: _model.optionNameControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
