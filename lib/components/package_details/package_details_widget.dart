    ...
    return StreamBuilder<List<PackagesRecord>>(
      stream: queryPackagesRecord(
        ...
        queryBuilder: (packagesRecord) => packagesRecord.where(
          'order_id',
          isEqualTo: widget.orderDocument?.orderId,
        ),
      ),
      builder: (context, snapshot) {
        ...
        List<PackagesRecord> containerPackagesRecordList = snapshot.data!;
        return Material(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          formatNumber(
                            functions.returnGrandTotalOfPackages(
                  ...
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final packagesList =
                            containerPackagesRecordList.map((e) => e).toList();
                        return SingleChildScrollView(
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            children: List.generate(packagesList.length,
                                (packagesListIndex) {
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '${packagesListItem.quantity.toString()} ${packagesListItem.unit}',
                                                style:
